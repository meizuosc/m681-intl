...
#define SENSOR_TYPE_PROXIMITY_WAKEUP           32
...
#define ID_PROXIMITY_WAKEUP       (ID_BASE+SENSOR_TYPE_PROXIMITY_WAKEUP-1)
#define ID_SENSOR_MAX_HANDLE	  (ID_BASE+SENSOR_TYPE_PROXIMITY_WAKEUP)
