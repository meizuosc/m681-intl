...
static s32 gtp_init_panel(struct i2c_client *client)
{
...
#if GTP_CHARGER_SWITCH
    u8 *send_charger_cfg_buf[] = {cfg_info_group1_charger, cfg_info_group2_charger, cfg_info_group3_charger,
    ...
    u8 charger_cfg_info_len[] = { CFG_GROUP_LEN(cfg_info_group1_charger), 
                          			CFG_GROUP_LEN(cfg_info_group2_charger),
                          			CFG_GROUP_LEN(cfg_info_group3_charger),
                          			CFG_GROUP_LEN(cfg_info_group4_charger), 
                          			CFG_GROUP_LEN(cfg_info_group5_charger),
                          			CFG_GROUP_LEN(cfg_info_group6_charger)};
#endif
...
static int touch_event_handler(void *unused)
{
   ...
   u8  rqst_data[3] = {(u8)(GTP_REG_RQST >> 8), (u8)(GTP_REG_RQST & 0xFF), 0};
    ...
    #endif
	printk("GTP the tpd_halt = %d the is_reseting = %d the load_fw_process = %d \n",tpd_halt,is_reseting,load_fw_process);/*
