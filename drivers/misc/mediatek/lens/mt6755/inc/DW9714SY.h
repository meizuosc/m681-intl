...
#define DW9714SYIOC_G_MOTORINFO _IOR(DW9714SY_MAGIC, 0, stDW9714SY_MotorInfo)

#define DW9714SYIOC_T_MOVETO _IOW(DW9714SY_MAGIC, 1, u32)

#define DW9714SYIOC_T_SETINFPOS _IOW(DW9714SY_MAGIC, 2, u32)

#define DW9714SYIOC_T_SETMACROPOS _IOW(DW9714SY_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define DW9714SYIOC_G_MOTORMETAINFO _IOR(DW9714SY_MAGIC, 4, stDW9714SY_MotorMETAInfo)
#endif
