	   ...
	   DSI_POLLREG32(cmdq_trigger_handle, &DSI_REG[1]->DSI_INTSTA, 0x80000000, 0); 
			 ...
			 { 
					  ...
					  { 
							   ...
							   /// 0xB0 is used to distinguish DCS cmd or Gerneric cmd, is that Right??? 
							   t0.Data_ID = (t0.Data0 < 0xB0) ? DSI_DCS_READ_PACKET_ID : DSI_DCS_READ_PACKET_ID;; 
							   t0.Data1   = 0; 
							   t1.CONFG = 0x00; 
...
//add ql
					  ...
					  { 						
							...
							//DISPDBG("[DSI]enter cmp DSI+0x60=0x%x\n",AS_UINT32(DDP_REG_BASE_DSI0+0x60)); 
							   ...
							   { 
									...
									if(i!=2) 
									{ 
									   // printk("fxl1 %x,%x,%x\n",(int)dsi_params->lcm_esd_check_table[i].cmd,(int)data_arr[j],(int)dsi_params->lcm_esd_check_table[i].para_list[j]);
	...
	//-0111--0111\D0\u07b8\C4\u046d\BB\B7\B4\CE\D0\F2 
