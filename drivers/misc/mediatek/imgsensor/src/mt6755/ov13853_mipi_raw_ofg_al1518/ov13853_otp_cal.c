...
static kal_uint16 OV13853_R2A_read_i2c(kal_uint32 addr)
{
...
static kal_uint16 OV13853_R2A_write_i2c(addr, para)
{
...
void ofg_otp_cali(unsigned char writeid)
{
...
static int Decode_13853R2A(unsigned char*pInBuf, unsigned char* pOutBuf)
{
	if(pInBuf != NULL)
	{
