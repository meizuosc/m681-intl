...
void HI553_Sensor_calc_wbdata(void)
{
	...
	wb_flag = HI553_Sensor_OTP_read(0x0535,0,0);
    LOG_INF("HI553_Sensor_calc_wbdata wb_flag = 0x%x\n",wb_flag);
    ...
    HI553_Sensor_update_wb_gain( r_gain, b_gain, g_gain);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_SET_ESHUTTER:
			LOG_INF("SENSOR_FEATURE_SET_ESHUTTER shutter = %lld \n", *feature_data);
