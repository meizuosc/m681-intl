...
#ifdef CONFIG_HQ_FLASHLIGHT_IC_LM3642     //zhangdong	2016-02-15
extern int init_LM3642(void);
extern int flashEnable_LM3642_led2(void);
extern int flashDisable_LM3642_led2(void);
extern int setDuty_LM3642_led2(kal_uint32 duty);
extern int m_duty2;
...
/* flashEnable_sky81296_1(); */
    ...
    PK_DBG("-%s: flashEnable_LM3642_led2\n", __func__);
#endif
	PK_DBG("FL_Enable-");
...
#ifdef CONFIG_HQ_FLASHLIGHT_IC_LM3642     //zhangdong	2016-01-15
	flashDisable_LM3642_led2();
    PK_DBG("[zhangdong]-%s: flashDisable_LM3642_led2\n", __func__);
#endif
	return 0;
}
...
#ifdef CONFIG_HQ_FLASHLIGHT_IC_LM3642     //zhangdong	2016-01-15
    PK_DBG("-%s: setDuty_LM3642_led2\n", __func__);
    setDuty_LM3642_led2(duty);
#endif
	PK_DBG("-%s: setDuty_LM3642_led2\n", __func__);
	return 0;
}
