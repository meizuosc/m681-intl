...
struct lsm6ds3_gyro_i2c_data {
	...
	int                     data_int[LSM6DS3_GYRO_AXES_NUM+1]; 
	int						sensitivity;
...
static int LSM6DS3_ReadGyroData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	#endif
		/*report degree/s */
		obj->data_int[LSM6DS3_AXIS_X] = (obj->data[LSM6DS3_AXIS_X])*LSM6DS3_GYRO_SENSITIVITY_2000DPS*131/1000;
		obj->data_int[LSM6DS3_AXIS_Y] = (obj->data[LSM6DS3_AXIS_Y])*LSM6DS3_GYRO_SENSITIVITY_2000DPS*131/1000;
		obj->data_int[LSM6DS3_AXIS_Z] = (obj->data[LSM6DS3_AXIS_Z])*LSM6DS3_GYRO_SENSITIVITY_2000DPS*131/1000;

		obj->data_int[LSM6DS3_AXIS_X] += obj->cali_sw[LSM6DS3_AXIS_X];
		obj->data_int[LSM6DS3_AXIS_Y] += obj->cali_sw[LSM6DS3_AXIS_Y];
		obj->data_int[LSM6DS3_AXIS_Z] += obj->cali_sw[LSM6DS3_AXIS_Z];

		/*remap coordinate*/
		data[obj->cvt.map[LSM6DS3_AXIS_X]] = obj->cvt.sign[LSM6DS3_AXIS_X] * obj->data_int[LSM6DS3_AXIS_X];
		data[obj->cvt.map[LSM6DS3_AXIS_Y]] = obj->cvt.sign[LSM6DS3_AXIS_Y] * obj->data_int[LSM6DS3_AXIS_Y];
		data[obj->cvt.map[LSM6DS3_AXIS_Z]] = obj->cvt.sign[LSM6DS3_AXIS_Z] * obj->data_int[LSM6DS3_AXIS_Z];
#else
	...
	{
		if(lsm6ds3_gyro_discard_data_count <=6){
			 data[LSM6DS3_AXIS_X] = lsm6ds3_gyro_discard_data_count;
			 data[LSM6DS3_AXIS_Y] = lsm6ds3_gyro_discard_data_count;
			 data[LSM6DS3_AXIS_Z] = lsm6ds3_gyro_discard_data_count;
