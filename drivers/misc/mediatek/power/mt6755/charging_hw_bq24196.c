...
extern int temp_rise_flag;
extern int bat_temp_Avg;
extern int chr_typeNum;
/* ============================================================ // */
/* Define */
/* ============================================================ // */
#define STATUS_OK	0
...
static kal_uint32 charging_hw_init(void *data)
{
	...
	bq24196_set_en_timer(0x0);	/* Enable charge timer */
	//bq24196_set_chg_timer(0x02);	/*set charge time 12h*/
...
static kal_uint32 charging_set_current(void *data)
{
	...
	kal_uint32 current_value = *(kal_uint32 *) data;
		if(temp_rise_flag==1  && current_value == 175000 &&  bat_temp_Avg>=10 && chr_typeNum==4)
			current_value=105000;
		if(bat_temp_Avg<10 && bat_temp_Avg>=0 && chr_typeNum==4)
			current_value=83200;
	battery_log(BAT_LOG_CRTI, "charging_set_cc_current set_cc_current=%d\n",*(kal_uint32 *) data);
