...
#ifndef BH1745_DEBUG
#define BH1745_DEBUG   //comment out here for close debug info
#endif

#ifdef BH1745_DEBUG
#define  BH1745_FUN()					do {printk(KERN_ERR "ALS/PS:BH1745 (%s, %d)", __func__,  __LINE__);} while (0)
#define  BH1745_ERR(f, a...)   		do {printk(KERN_ERR "ALS/PS:BH1745 (%s, %d):", __func__,  __LINE__);   printk(KERN_ERR f, ## a);} while (0)
#define  BH1745_WARNING(f, a...)   	do {printk(KERN_ERR "ALS/PS:BH1745 (%s, %d):", __func__,  __LINE__);   printk(KERN_ERR f, ## a);} while (0)
#define  BH1745_INFO(f, a...)   		do {printk(KERN_ERR "ALS/PS:BH1745 (%s, %d):", __func__,  __LINE__);   printk(KERN_ERR f, ## a);} while (0)
#define  BH1745_DBG(f, a...)   		do {printk(KERN_ERR "ALS/PS:BH1745 (%s, %d):", __func__,  __LINE__);   printk(KERN_ERR f, ## a);} while (0)
#else
#define  BH1745_FUN()   				do {} while (0)
#define  BH1745_ERR(f, a...)   		do {} while (0)
...
#define BH1745_DRIVER_VER      ("0.1.0")
