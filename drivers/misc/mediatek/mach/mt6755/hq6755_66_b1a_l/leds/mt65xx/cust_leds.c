 ...
 *-------------------------------------------------------------------------------------------
 */
 extern int LM3642_torch_mode(int level);

 static int al1518_torch_custom(int level)
 {
 	return LM3642_torch_mode(level);
 }
...
static struct cust_mt65xx_led cust_led_list[MT65XX_LED_TYPE_TOTAL] = {
	...
	{"torch",             MT65XX_LED_MODE_GPIO, al1518_torch_custom,{0}},
};
